...
export default function KakaoCallbackPage() {
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4">
            <Suspense fallback={
                <div className="w-full max-w-md bg-white rounded-3xl shadow-xl border border-gray-100 p-8 md:p-10 text-center flex flex-col items-center justify-center">
                    <Loader2 size={48} className="text-indigo-600 animate-spin mb-6" />
                    <h1 className="text-2xl font-black text-gray-900 tracking-tight mb-2">로딩 중</h1>
                </div>
            }>
                <CallbackContent />
            </Suspense>
